...
<form action="#" method="post">
    <div class="form-group">
        ...
        <input name="title" value="Página Inicial" id="titlePages" type="text" class="form-control" placeholder="Título da Página">
    </div>
    <div class="form-group">
        <label for="urlPages">URL</label>
        <div class="input-group">
        <div class="input-group-prepend"><span class="input-group-text">/</span></div>
        <input name="url" value="/" id="urlPages" type="text" class="form-control" placeholder="Deixe em branco para início">
        </div>
    </div>
    <div class="form-group">
        <label for="editorPages">Editor de Textos</label>
        <input name="body" type="hidden" id="bodyPages" value="Esta é a página inicial">
