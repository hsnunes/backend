<div class="container">
<h3 class="m-3">Criação de Usuários</h3>

<form action="#" method="POST">
    <div class="form-group">
        <label for="emailUsers">Email</label>
        <input name="email" id="emailUsers" type="email" class="form-control" placeholder="Email">
    </div>
    <div class="form-group">
        <label for="loginUsers">Login</label>
        <input name="url" id="loginUsers" type="text" class="form-control" placeholder="Seu Login">
    </div>
    <div class="form-group">
